        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-2 py-1">
            ...
            <button
              ...
              className="rounded-full bg-white px-3 py-1 text-sm font-medium text-slate-700 shadow-sm border border-slate-200 hover:border-primary hover:text-primary transition-colors"
            >
              {i18n.language === "de" ? t("english") : t("german")}
            </button>
          </div>
